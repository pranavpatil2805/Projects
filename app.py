...
def main():
    ...
    with st.sidebar:
        ...
        website_menu = st.sidebar.selectbox("Menu", ("Emotion Recognition", "Image_emotion_detection","Text_emotion_detection"))
    ...
    elif website_menu == "Text_emotion_detection":
        app()
